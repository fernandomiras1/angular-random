...
const URL_DOMAIN = 'http://localhost:4200';
...
export const environment = {
  ...
  auth0: {
    ...
    audience: 'https://naranja.com/npromociones/api',
  ...
  endpoints: {
    BASE_URL_BFF: 'https://bff.dev.promotions.us-east-1.awsnaranja.com/bff-promotions-web/api/bff-promotions',
  ...
  contentful: {
    BASE_URL_WEB: 'https://e1-www.naranja.com',
    BASE_URL_BFF: 'https://e1-webnaranja.backendnaranja.com',
  },
  watchdogTimer: 1000,
