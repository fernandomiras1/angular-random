...
describe('MapNearYouComponent - mobile', () => {
  let component: MapNearYouComponent;
  let fixture: ComponentFixture<MapNearYouComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(MapNearYouComponent);
  ...
  it('getMarkers() should returns if component.promos is empty', () => {
    component.promos = [];
    component.currentLocality = 'Córdoba';
    component.markers = [{ marker: 'marker' }];
    const spy = spyOn(component, 'getAddress').and.returnValue(true);
