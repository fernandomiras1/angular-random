...
describe('filter-data: actions ', () => {
  it('FetchPending -- should create an action', () => {
    ...
    expect({ ...action }).toEqual({
      type: fromActions.PromotionsActionsTypes.FETCH_PENDING,
      payload: fakeParams,
    });
  });
  ...
  it('FetchFulfilled -- should create an action', () => {
    ...
    expect({ ...action }).toEqual({
      type: fromActions.PromotionsActionsTypes.FETCH_FULFILLED,
      payload: fakeParams,
    });
  });
  ...
  it('FetchError -- should create an action', () => {
    ...
    expect({ ...action }).toEqual({
      type: fromActions.PromotionsActionsTypes.FETCH_ERROR,
      payload: fakeParams,
    });
  });
  ...
  it('ClearData -- should create an action', () => {
    ...
    expect({ ...action }).toEqual({
      type: fromActions.PromotionsActionsTypes.CLEAR_DATA,
    });
  });
});
