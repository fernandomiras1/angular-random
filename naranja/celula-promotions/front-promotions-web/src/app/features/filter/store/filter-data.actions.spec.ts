import * as fromActions from './filter-data.actions';
...
describe('filter-data: actions ', () => {
  it('FetchPending -- should create an action', () => {
    ...
    expect({ ...action }).toEqual({
      type: fromActions.FilterDataActionsTypes.FETCH_PENDING,
      payload: fakeParams,
    });
  });
  ...
  it('FetchFulfilled -- should create an action', () => {
    ...
    expect({ ...action }).toEqual({
      type: fromActions.FilterDataActionsTypes.FETCH_FULFILLED,
      payload: fakeParams,
    });
  });
  ...
  it('FetchError -- should create an action', () => {
    ...
    expect({ ...action }).toEqual({
      type: fromActions.FilterDataActionsTypes.FETCH_ERROR,
      payload: fakeParams,
    });
  });
  ...
  it('ClearData -- should create an action', () => {
    ...
    expect({ ...action }).toEqual({
      type: fromActions.FilterDataActionsTypes.CLEAR_DATA,
    });
  });
});
