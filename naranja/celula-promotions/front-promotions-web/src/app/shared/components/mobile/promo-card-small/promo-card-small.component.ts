...
@Component({
  selector: 'app-promo-card-small',
  templateUrl: './promo-card-small.component.html',
  styleUrls: ['./promo-card-small.component.scss'],
})
export class PromoCardSmallComponent implements OnInit {
